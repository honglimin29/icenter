...
import (
	...
	"icenter/src/framework/api"
	"icenter/src/framework/core/config"
	"icenter/src/framework/core/discovery"
	"icenter/src/framework/core/httpserver"
	"icenter/src/framework/core/log"
	"icenter/src/framework/core/monitor/metric"
	"icenter/src/framework/core/option"
	"icenter/src/framework/core/output/module/client"
	_ "icenter/src/framework/plugins"
